        ...
        <div id="main_body">
        	...
        	<div style="height:145px;">
            	...
            	<div style="margin-top:0px; vertical-align:top; text-align:center">
			 	<span style="font-size:50px;">Deeper Life</span><br />
				<span style="font-size:50px">Campus Fellowship PS</span>
			 </div>
            ...
            <div id="area" style="text-align:center; padding-top:3px;">
    			...
    			<span align="center" style="font-size:24px; background:#FFF;"><span style="color:black;" class="min">10</span><span style="color:white;"> <span style="color:black"> : </span></span><span style="color:black;" class="sec">00</span></span>
				</div>
